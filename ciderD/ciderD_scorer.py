...
### for pycharm
# import sys
# sys.path.append("/data/rui.wu/yichen/self-critical.pytorch-master")
    ...
    def __init__(self, df_mode="corpus", test=None, refs=None, n=4, sigma=6.0):
        ...
        if self.df_mode != "corpus":
            ...
            try:
                ...
                pkl_file = pickle.load(open(os.path.join('/data/xiaobing.wang/ke.lin/image-cap-transformer/data', df_mode + '.p'), 'rb'))
